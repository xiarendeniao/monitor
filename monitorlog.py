import os, re, sys, time, logging, pprint, threading
...
def update(reportFunc):
    ...
    for f, ut in f2ut.iteritems():
        #posix.stat_result(st_mode=33188, st_ino=21103778, st_dev=2051L, st_nlink=1, st_uid=0, st_gid=0, st_size=2, st_atime=1472559215, st_mtime=1472572514, st_ctime=1472572514)
        st = os.stat(f) 
